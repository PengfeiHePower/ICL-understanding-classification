...
CUDA_VISIBLE_DEVICE=1 python infer.py -n_points 0 -bias1 0.5 -bias2 -0.5 -std 1.0 -p1 1.0 -p2 1.0 -frac_pos 0.5

CUDA_VISIBLE_DEVICE=1 python infer.py -n_points 100 -bias1 -0.5 -bias2 0.5 -std 1.0 -p1 1.0 -p2 1.0 -frac_pos 0

python infer.py -n_points 100 -bias1 -0.5 -bias2 0.5 -std 1.0 -p1 1.0 -p2 1.0 -frac_pos 0.5
